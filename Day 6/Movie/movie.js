...
let movie1 = new movie("Thiruchitrambalam","Sun Pictures","R");
movie1.Title();
movie1.Studio();
movie1.Rating();
...
let movie2 = new moviee("Pasanga 2","2D Entertainment");
movie2.Title();
movie2.Studio();
movie2.Rating();    
...
let movie3 = new movieNew("Viruman","2D Entertainment","PG13");
movie3.Title();
movie3.Studio();
movie3.Rating();
movie3.getPG();
...
//d) Write a piece of code that creates an instance of the class Movie
 ...
 class movies{
    ...
    var m=new movies('Casino Royale','Eon Productions','PG13');
    console.log(m)